...
/**
 * Demo UI HX SDK helper class which subclass AbsHXSDKHelper
 *
 * @author easemob
 */
public class HXSDKHelper extends AbsHXSDKHelper {
                ...
                switch (event.getEvent()) {
                    ...
                    case EventOfflineMessage:
                        if (activityList.size() <= 0) {
                            ...
                            AbsHXSDKHelper.getInstance().getNotifier().onNewMesg(messages);
                        }
                        break;
        ...
        return new HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if (isVideoCalling) {
                    ...
                    try {
                        sessionid = message.getStringAttribute("sessionid");
    ...
    public boolean saveContactList(List<User> contactList) {
        if (getHXId() != null && contactList != null) {
            return ((DemoHXSDKModel) getModel()).saveContactList(contactList);
        }
